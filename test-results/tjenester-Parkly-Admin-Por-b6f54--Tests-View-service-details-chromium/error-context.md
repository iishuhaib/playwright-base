...
- Name: Parkly Admin Portal - Tjenester (Services) Tests >> View service details
- Location: C:\Users\ShuhaibA\Desktop\parkly-tests\tests\tjenester.spec.ts:87:7

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: getByText('Tjeneste') resolved to 2 elements:
    1) <span _ngcontent-eal-c3="" class="nav-button__text">Tjenester</span> aka getByRole('link', { name: 'Tjenester' })
    2) <h1 _ngcontent-eal-c7="">Tjenester</h1> aka getByRole('heading', { name: 'Tjenester' })

Call log:
  - expect.toBeVisible with timeout 8000ms
  - waiting for getByText('Tjeneste')

    at C:\Users\ShuhaibA\Desktop\parkly-tests\tests\tjenester.spec.ts:101:64
```
